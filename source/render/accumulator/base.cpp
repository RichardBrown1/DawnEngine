	...
	class BaseAccumulator {
		...
		BaseAccumulator(WGPUContext* wgpuContext) : _wgpuContext(wgpuContext) {
			_computeShaderModule = device::createWGSLShaderModule(
				_wgpuContext->device,
				static_cast<Derived*>(this)->ACCUMULATOR_SHADER_LABEL,
				static_cast<Derived*>(this)->ACCUMULATOR_SHADER_PATH
			);
		};
		...
		void doCommands(const accumulator::descriptor::DoCommands* descriptor) {
